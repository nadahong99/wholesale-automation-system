# integrations/wholesalers/daemaepartner.py
"""Scraper for Daemaepartner (대매파트너) wholesale site."""
import re
...
class DaemaepartnerClient(BaseWholesalerClient):
    wholesaler_name = "daemaepartner"
    base_url = "https://www.daemaepartner.com"
    login_url = "https://www.daemaepartner.com/member/login.html"

    def __init__(self):
        super().__init__(
            username=settings.DAEMAEPARTNER_USERNAME,
            password=settings.DAEMAEPARTNER_PASSWORD,
        )
    ...
    def _scrape_products(self, max_products: int = 200) -> List[RawProduct]:
        ...
        while len(products) < max_products:
            ...
            items = soup.select(".xans-record- li.item, .prd-list li")
            if not items:
                break
            ...
            for item in items:
                ...
                try:
                    ...
                    price_el = item.select_one(".price .sale, .sale-price")
